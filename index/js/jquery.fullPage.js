...
(function($) {
	$.fn.fullpage = function(options) {
		...
		*/
		...
		nav.find("li span").eq(0).text("首页");
		nav.find("li span").eq(1).text("关于");
		nav.find("li span").eq(2).text("项目作品");
		nav.find("li span").eq(3).text("职业技能");
		nav.find("li span").eq(4).text("职业履历");
		nav.find("li span").eq(5).text("联系我");
